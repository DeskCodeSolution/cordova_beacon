...
var _ = require('com.deskcode.cordova.beacon.underscorejs');
var Q = require('com.deskcode.cordova.beacon.Q');

var Regions = require('com.deskcode.cordova.beacon.Regions');
var Delegate = require('com.deskcode.cordova.beacon.Delegate');

var Region = require('com.deskcode.cordova.beacon.Region');
var CircularRegion = require('com.deskcode.cordova.beacon.CircularRegion');
var BeaconRegion = require('com.deskcode.cordova.beacon.BeaconRegion');
...
LocationManager.prototype.openSetting = function(setting, onsucess, onfail) {
	var settings = (typeof setting === 'string' || setting instanceof String) ? [setting] : setting;
	cordova.exec(onsucess, onfail, "LocationManager", "openSetting", settings);
};

LocationManager.prototype.openAppSetting = function(setting, onsucess, onfail) {
	var settings = (typeof setting === 'string' || setting instanceof String) ? [setting] : setting;
	cordova.exec(onsucess, onfail, "LocationManager", "openAppSetting", settings);
};
